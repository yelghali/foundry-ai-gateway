...
```
Foundry Agent Service ──> ApiManagement connection ──> APIM (Parts 1–3) ──> Foundry models (2 regions)
        (prompt agent)        (category: ApiManagement)     (backend pool / load balance / retry)
```
